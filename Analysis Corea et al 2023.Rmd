...
source("Input_Static.R")
Outs_DFs_4sb3TIC<-Obtaining_Spoiled_Milks_DFs(N_Years = 50, Service_Length = 50,TurningT_Length = 7)

source("Input_Static.R")
Outs_DFs_4sb3TIP<-Obtaining_Spoiled_Milks_DFs(N_Years = 50, Service_Length = 50,TurningT_Length = 7)
...
RTB_List_Time<-c()
for (i in 1:50){
  RTB_List_Time<-c(RTB_List_Time,RTB_List[[i]]$TotTime)
}

mean(RTB_List_Time) #CFU/mL
range (RTB_List_Time)
quantile(RTB_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
...
quantile(HighCont_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
```
...
quantile(VeryHighCont_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
```
...
quantile(MedCont_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
```
...
quantile(LowCont_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
```
...
quantile(s54b_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
```
#5s4BTIC
```{r}
s54b_List<-list()  
Output_Milk_s54b<-Spoilage_Function_Single_Milk(Cont = 2.44, Pop_Max =8.14, Time_Temp_df = Df_RT_MT_s5b4TIC, Interval =1/60,AF = 1.32)
Changes_Over_Time_s54b<-Output_Milk_s54b[[2]]
for (i in 1:50){
  AnalysysDF_s54b<- Appling_Changes(df = Outs_DFs_5s4b[[i]], Changes_Over_Time = Changes_Over_Time_s54b)
  s54b_List<-append(s54b_List,list(AnalysysDF_s54b))
...
```{r}
s54b_List<-list()  
Output_Milk_s54b<-Spoilage_Function_Single_Milk(Cont = 2.44, Pop_Max =8.14, Time_Temp_df = Df_RT_MT_s5b4TIP, Interval =1/60,AF = 1.32)
Changes_Over_Time_s54b<-Output_Milk_s54b[[2]]
for (i in 1:50){
  AnalysysDF_s54b<- Appling_Changes(df = Outs_DFs_5s4b[[i]], Changes_Over_Time = Changes_Over_Time_s54b)
  s54b_List<-append(s54b_List,list(AnalysysDF_s54b))
...
quantile(s43b_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
...
```{r}
s43b_List<-list()  
Output_Milk_s43b<-Spoilage_Function_Single_Milk(Cont = 2.44, Pop_Max =8.14, Time_Temp_df = Df_RT_MT_s4b3TIC, Interval =1/60,AF = 1.32)
Changes_Over_Time_s43b<-Output_Milk_s43b[[2]]
for (i in 1:50){
  AnalysysDF_s43b<- Appling_Changes(df = Outs_DFs_4s3b[[i]], Changes_Over_Time = Changes_Over_Time_s43b)
  s43b_List<-append(s43b_List,list(AnalysysDF_s43b))
...
```{r}
s43b_List<-list()  
Output_Milk_s43b<-Spoilage_Function_Single_Milk(Cont = 2.44, Pop_Max =8.14, Time_Temp_df = Df_RT_MT_s4b3TIP, Interval =1/60,AF = 1.32)
Changes_Over_Time_s43b<-Output_Milk_s43b[[2]]
for (i in 1:50){
  AnalysysDF_s43b<- Appling_Changes(df = Outs_DFs_4s3b[[i]], Changes_Over_Time = Changes_Over_Time_s43b)
  s43b_List<-append(s43b_List,list(AnalysysDF_s43b))
...
quantile(s1b0_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
...
quantile(s2b1_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
...
quantile(SToff_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
...
```{r}
s3b2_List<-list()  
Output_Milk_s3b2<-Spoilage_Function_Single_Milk(Cont = 2.44, Pop_Max =8.14, Time_Temp_df = Df_RT_MT_s3b2, Interval =1/60,AF = 1.32)
...
s3b2_List_per_spoiled<-list() 
for (i in 1:50){
  s3b2_List_per_spoiled<-append(s3b2_List_per_spoiled,list(summary_per_spoiled(s3b2_List[[i]])))
}

Total_Milks_Spoiled_s3b2<-Extracting_Total_SpoiledMilks(Output_Name = s3b2_List_per_spoiled, N_Years = 50)

Total_Milks_Spoiled_s3b2
mean(Total_Milks_Spoiled_s3b2)
range (Total_Milks_Spoiled_s3b2)



#Range of milks per year
s3b2_List_total_milks<-c()
for (i in 1:50){
  s3b2_List_total_milks<-c(s3b2_List_total_milks,length(s3b2_List[[i]]$ID))
}
mean(s3b2_List_total_milks)
range(s3b2_List_total_milks)


#Percentage of spoiled milks per year
s3b2_List_pecentage_spoiled<-c()
for (i in 1:50){
 s3b2_List_pecentage_spoiled<-c(s3b2_List_pecentage_spoiled,(sum(s3b2_List[[i]]$SpoilageCon>6)/length(s3b2_List[[i]]$SpoilageCon)))
}

mean(s3b2_List_pecentage_spoiled)
range (s3b2_List_pecentage_spoiled)

#Population Summary
s3b2_List_population<-c()
for (i in 1:50){
  s3b2_List_population<-c(s3b2_List_population,s3b2_List[[i]]$SpoilageCon)
}

mean(s3b2_List_population) #CFU/mL
range (s3b2_List_population)

#Time in System
s3b2_List_Time<-c()
for (i in 1:50){
  s3b2_List_Time<-c(s3b2_List_Time,s3b2_List[[i]]$TotTime)
}

mean(s3b2_List_Time) #CFU/mL
range (s3b2_List_Time)
quantile(s3b2_List_Time, probs=c(10, 20, 30, 40, 50, 60, 70, 80, 85, 88, 89, 90, 95)/100)
