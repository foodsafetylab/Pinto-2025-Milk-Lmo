...
AnalysysDF_list<- c("AnalysysDF_RTB", "AnalysysDF_RT", "AnalysysDF_TIP", "AnalysysDF_TIC", 
                    ...
                    "AnalysysDF_s4b3TIP","AnalysysDF_s5b4TIC","AnalysysDF_s5b4TIC",
                    "AnalysysDF_SToff")
...
dose_response_listeria <- function(df, r_mean, r_sd, serving_size, scenario) {
  ...
  result <- data.frame(scenario = scenario,
                       mean = mean(df$p_ill, na.rm = TRUE))
  return(result)
}

### Run DR for 22 scenario and get Pill mean using for loop 
...
### output the excel
writexl::write_xlsx(DR_result_conbimed, path = "Output Data/DR_Output_for_22_Scenarios.xlsx")
```
...
DF_RT_list<- c("Df_RT_MT_RTB", "Df_RT_MT_RT", "Df_RT_MT_TIP", "Df_RT_MT_TIC", 
                  ...
                  "Df_RT_MT_s4b3TIC", "Df_RT_MT_s4b3TIP", "Df_RT_MT_s5b4TIC", "Df_RT_MT_s5b4TIP", "Df_RT_MT_RTB")
...
##### output the excel
writexl::write_xlsx(Time_1log_result_conbimed, path = "Output Data/Time_to_1log_22_Scenarios.xlsx")
```
...
# Run the function to 22 scenarios 
