...
#Lengths for milk model #need to make sense with no services all have to add up to 1440
  Time_Service_Length = 30 #Baseline is 50
  Time_Turnaround_Length = 14 #Baseline 25
  Time_Overnight_Length = 1366 #Baseline is 1315, A day has 1440 min
...
# Inputs Behavioral Probabilities -----------------------------------------
  ...
  Spoilage_Treshold<-2 #For LM updated to 2, since this will be the level we set for baseline
