...
```{r}
Time_Temp_Df_s3b2<-Create_Temperature_Profile_days(First_Cond = "Room Temp", 
                                                  Second_Cond = "Refrigeration", 
                                                  First_Cond_Total_Time = 124,
                                                  Second_Cond_Total_Time = 1314,
                                                  First_Cond_Mean_Temperature = 22.1, 
...
Temp_Milk_Vectors_s3b2<-predict_full_milk_temp(df = Time_Temp_Df_s3b2, Temp_Initial = 4)

Df_RT_MT_s3b2<-data.frame("RoomTemp" = Time_Temp_Df_s3b2$Rtemp,
                     "MilkTemp" = Temp_Milk_Vectors_s3b2,
                     "Time" = 1:length(Temp_Milk_Vectors_s3b2))
Df_RT_MT_s3b2_melted<-melt(Df_RT_MT_s3b2, id.vars = "Time")
Df_RT_MT_s3b2_melted$Condition = "3 Lunches (31 min) with 2 break (16 min)"
Df_RT_MT_s3b2_melted$Scenario = "Bell Schedule Scenarios"


#Saving as CSV
write.csv(Df_RT_MT_s3b2, file = "Pedicted Time and Temp Profiles/Df_RT_MT_s3b2.csv")
```
...
##s4b3TIC
```{r}
Time_Temp_Df_s4b3TIC<-Create_Temperature_Profile_days(First_Cond = "Tray With Ice", 
                                                  Second_Cond = "Refrigeration", 
                                                  First_Cond_Total_Time = 221,
                                                  Second_Cond_Total_Time = 1219,
                                                  First_Cond_Mean_Temperature = 22.1, 
...
Temp_Milk_s4b3TIC<-predict_full_milk_temp(Time_Temp_Df_s4b3TIC, Temp_Initial = 4.2)

Df_RT_MT_s4b3TIC<-data.frame("RoomTemp" = Time_Temp_Df_s4b3TIC$Rtemp,
                         "MilkTemp" = Temp_Milk_s4b3TIC,
                         "Time" = 1:length(Temp_Milk_s4b3TIC))

Df_RT_MT_s4b3TIC_melted<-melt(Df_RT_MT_s4b3TIC, id.vars = "Time")
Df_RT_MT_s4b3TIC_melted$Condition = "4 Lunch (50 min) with 3 breaks (7 min) under Tray with Ice"
Df_RT_MT_s4b3TIC_melted$Scenario = "Longer Bell Schedules Plus Storage System"


write.csv(Df_RT_MT_s4b3TIC, file = "Pedicted Time and Temp Profiles/Df_RT_MT_s4b3TIC.csv")
```

Plotting it
```{r}
ggplot(data = Df_RT_MT_s4b3TIC_melted, aes(x = Time, y = value, color = variable))+
  geom_line(size = 1)+
  theme_bw()+
  labs(x = "Time (min)", y = "Temperature (°C)", title= "4 Lunch (50 min) with 3 breaks (7 min) under Tray with Ice")+
  scale_color_discrete(name = "Temperature Profile")

#ggsave("Pedicted Time and Temp Profiles/Predicteds4b3TIC.png", height = 3, width = 8, dpi = 300)
```

##s4b3TIP
```{r}
Time_Temp_Df_s4b3TIP<-Create_Temperature_Profile_days(First_Cond = "Tray With Ice Packs", 
                                                  Second_Cond = "Refrigeration", 
                                                  First_Cond_Total_Time = 221,
                                                  Second_Cond_Total_Time = 1219,
                                                  First_Cond_Mean_Temperature = 22.1, 
...
Temp_Milk_s4b3TIP<-predict_full_milk_temp(Time_Temp_Df_s4b3TIP, Temp_Initial = 4.2)

Df_RT_MT_s4b3TIP<-data.frame("RoomTemp" = Time_Temp_Df_s4b3TIP$Rtemp,
                         "MilkTemp" = Temp_Milk_s4b3TIP,
                         "Time" = 1:length(Temp_Milk_s4b3TIP))

Df_RT_MT_s4b3TIP_melted<-melt(Df_RT_MT_s4b3TIP, id.vars = "Time")
Df_RT_MT_s4b3TIP_melted$Condition = "4 Lunch (50 min) with 3 breaks (7 min) under Tray with Ice Packs"
Df_RT_MT_s4b3TIP_melted$Scenario = "Longer Bell Schedules Plus Storage System"


write.csv(Df_RT_MT_s4b3TIP, file = "Pedicted Time and Temp Profiles/Df_RT_MT_s4b3TIP.csv")
```

Plotting it
```{r}
ggplot(data = Df_RT_MT_s4b3TIP_melted, aes(x = Time, y = value, color = variable))+
  geom_line(size = 1)+
  theme_bw()+
  labs(x = "Time (min)", y = "Temperature (°C)", title= "4 Lunch (50 min) with 3 breaks (7 min) under Tray with Ice Packs")+
  scale_color_discrete(name = "Temperature Profile")

#ggsave("Pedicted Time and Temp Profiles/Predicteds4b3TIP.png", height = 3, width = 8, dpi = 300)
```
...
##s5b4TIC
```{r}
Time_Temp_Df_s5b4TIC<-Create_Temperature_Profile_days(First_Cond = "Tray With Ice", 
                                                  Second_Cond = "Refrigeration", 
                                                  First_Cond_Total_Time = 266,
                                                  Second_Cond_Total_Time = 1174,
                                                  First_Cond_Mean_Temperature = 22.1, 
...
Temp_Milk_s5b4TIC<-predict_full_milk_temp(Time_Temp_Df_s5b4TIC, Temp_Initial = 4.2)

Df_RT_MT_s5b4TIC<-data.frame("RoomTemp" = Time_Temp_Df_s5b4TIC$Rtemp,
                         "MilkTemp" = Temp_Milk_s5b4TIC,
                         "Time" = 1:length(Temp_Milk_s5b4TIC))

Df_RT_MT_s5b4TIC_melted<-melt(Df_RT_MT_s5b4TIC, id.vars = "Time")
Df_RT_MT_s5b4TIC_melted$Condition = "5 Lunch (50 min) with 4 breaks (4 min) Under Tray with Ice"
Df_RT_MT_s5b4TIC_melted$Scenario = "Longer Bell Schedules Plus Storage System"


write.csv(Df_RT_MT_s5b4TIC, file = "Pedicted Time and Temp Profiles/Df_RT_MT_s5b4TIC.csv")
```

Plotting it
```{r}
ggplot(data = Df_RT_MT_s5b4TIC_melted, aes(x = Time, y = value, color = variable))+
  geom_line(size = 1)+
  theme_bw()+
  labs(x = "Time (min)", y = "Temperature (°C)", title= "5 Lunch (50 min) with 4 breaks (4 min) Under Tray with Ice")+
  scale_color_discrete(name = "Temperature Profile")

#ggsave("Pedicted Time and Temp Profiles/Predicteds5b4TIC.png", height = 3, width = 8, dpi = 300)
```


##s5b4TIP
```{r}
Time_Temp_Df_s5b4TIP<-Create_Temperature_Profile_days(First_Cond = "Tray With Ice Packs", 
                                                  Second_Cond = "Refrigeration", 
                                                  First_Cond_Total_Time = 266,
                                                  Second_Cond_Total_Time = 1174,
                                                  First_Cond_Mean_Temperature = 22.1, 
...
Temp_Milk_s5b4TIP<-predict_full_milk_temp(Time_Temp_Df_s5b4TIP, Temp_Initial = 4.2)

Df_RT_MT_s5b4TIP<-data.frame("RoomTemp" = Time_Temp_Df_s5b4TIP$Rtemp,
                         "MilkTemp" = Temp_Milk_s5b4TIP,
                         "Time" = 1:length(Temp_Milk_s5b4TIP))

Df_RT_MT_s5b4TIP_melted<-melt(Df_RT_MT_s5b4TIP, id.vars = "Time")
Df_RT_MT_s5b4TIP_melted$Condition = "5 Lunch (50 min) with 4 breaks (4 min) Under Tray with Ice Packs"
Df_RT_MT_s5b4TIP_melted$Scenario = "Longer Bell Schedules Plus Storage System"


write.csv(Df_RT_MT_s5b4TIP, file = "Pedicted Time and Temp Profiles/Df_RT_MT_s5b4TIP.csv")
```

Plotting it
```{r}
ggplot(data = Df_RT_MT_s5b4TIP_melted, aes(x = Time, y = value, color = variable))+
  geom_line(size = 1)+
  theme_bw()+
  labs(x = "Time (min)", y = "Temperature (°C)", title= "5 Lunch (50 min) with 4 breaks (4 min) Under Tray with Ice Packs")+
  scale_color_discrete(name = "Temperature Profile")

#ggsave("Pedicted Time and Temp Profiles/Predicteds5b4TIP.png", height = 3, width = 8, dpi = 300)
```
...
ggsave("Pedicted Time and Temp Profiles/All Temp Combined Temperature.png", height = 10, width = 10, dpi = 300)
```
